#!/bin/sh
#SBATCH -p normal,owners,shenoy,shauld
...
source /oak/stanford/groups/shenoy/ghwilson/miniconda3/etc/profile.d/conda.sh
conda activate nonstationarities

python /home/users/ghwilson/projects/nonstationarities/simulator_notebooks/efficiency_sweep.py --n_jobs 600 --jobID=$SLURM_ARRAY_TASK_ID --saveDir '/oak/stanford/groups/shenoy/ghwilson/nonstationarities/simulator/efficiency/'
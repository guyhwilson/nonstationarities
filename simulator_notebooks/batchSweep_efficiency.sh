...
python /home/users/ghwilson/projects/nonstationarities/simulator_notebooks/efficiency_sweep.py --n_jobs 100 --jobID=$SLURM_ARRAY_TASK_ID --saveDir '/oak/stanford/groups/henderj/ghwilson/nonstationarities/simulator/performance/efficiency_ss/'
...
if __name__ == '__main__':
    ...
    method_opts    = [hmm_opts, click_hmm_opts, rti_opts, long_rti_opts, supervised_opts] * reps
    method_opts    = [ss_opts] * reps
    ...
    sweep_scores = Parallel(n_jobs= -1, verbose = 11)(delayed(testMethod)(*x, save_fields = ['nSimSteps']) for x in sweep_opts)
        
    np.save(os.path.join(args.saveDir, f'efficiency_scores_{625 + args.jobID}.npy'), sweep_scores)
    print('Finished.')

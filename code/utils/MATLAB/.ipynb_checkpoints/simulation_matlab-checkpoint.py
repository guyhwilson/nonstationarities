...
def simulateBCIFitts(neuralTuning, D, alpha, beta, nDelaySteps, delT, nStepsForSim, addpath = 'utils/MATLAB/', engine = None):
...
def simulateBCIFitts_parallel(neural_list, D, alpha, beta, nDelaySteps, delT, nStepsForSim, addpath = 'utils/MATLAB/', engine = None):

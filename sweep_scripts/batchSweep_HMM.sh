...
#python3 /home/users/ghwilson/projects/nonstationarities/sweep_scripts/optimizeHMM.py --participant T5 --n_jobs 600 --jobID=$SLURM_ARRAY_TASK_ID --saveDir '/oak/stanford/groups/shenoy/ghwilson/nonstationarities/T5/HMM/HMMsweep/'
